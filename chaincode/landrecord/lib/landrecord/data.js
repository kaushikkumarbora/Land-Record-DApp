...
function dataGeo (args) {
  if (typeof args.Latitude != 'string')
    throw new Error('Need string type Latitude')

  if (typeof args.Longitude != 'string')
    throw new Error('Need string type Longitude')
...
function dataRegistration (args) {
  ...
  if (typeof args.Status) args.Status = 'Pending'

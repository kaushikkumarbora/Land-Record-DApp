...
docker exec registry-cli  bash -c 'peer lifecycle chaincode commit -C records -n recordschaincode -v 0.0 --sequence 1 --tls --cafile $ORDERER_TLS_ROOTCERT_FILE --peerAddresses registry-peer:7051 --tlsRootCertFiles crypto-config/peerOrganizations/registry-org/peers/registry-peer/tls/ca.crt --peerAddresses appraiser-peer:7051 --tlsRootCertFiles crypto-config/peerOrganizations/appraiser-org/peers/appraiser-peer/tls/ca.crt --peerAddresses audit-peer:7051 --tlsRootCertFiles crypto-config/peerOrganizations/audit-org/peers/audit-peer/tls/ca.crt --peerAddresses bank-peer:7051 --tlsRootCertFiles crypto-config/peerOrganizations/bank-org/peers/bank-peer/tls/ca.crt --peerAddresses fico-peer:7051 --tlsRootCertFiles crypto-config/peerOrganizations/fico-org/peers/fico-peer/tls/ca.crt --peerAddresses insurance-peer:7051 --tlsRootCertFiles crypto-config/peerOrganizations/insurance-org/peers/insurance-peer/tls/ca.crt --peerAddresses title-peer:7051 --tlsRootCertFiles crypto-config/peerOrganizations/title-org/peers/title-peer/tls/ca.crt'
sleep ${FABRIC_START_WAIT}
echo "----------------------------- For books channel------------------------------------------------"
...
docker exec appraiser-cli  bash -c 'peer lifecycle chaincode commit -C books -n bookschaincode -v 0.0 --sequence 1 --tls --cafile $ORDERER_TLS_ROOTCERT_FILE --peerAddresses appraiser-peer:7051 --tlsRootCertFiles crypto-config/peerOrganizations/appraiser-org/peers/appraiser-peer/tls/ca.crt --peerAddresses registry-peer:7051 --tlsRootCertFiles crypto-config/peerOrganizations/registry-org/peers/registry-peer/tls/ca.crt --peerAddresses audit-peer:7051 --tlsRootCertFiles crypto-config/peerOrganizations/audit-org/peers/audit-peer/tls/ca.crt --peerAddresses bank-peer:7051 --tlsRootCertFiles crypto-config/peerOrganizations/bank-org/peers/bank-peer/tls/ca.crt --peerAddresses insurance-peer:7051 --tlsRootCertFiles crypto-config/peerOrganizations/insurance-org/peers/insurance-peer/tls/ca.crt --peerAddresses title-peer:7051 --tlsRootCertFiles crypto-config/peerOrganizations/title-org/peers/title-peer/tls/ca.crt'
sleep ${FABRIC_START_WAIT}
echo " ----------------- For lending channel ----------------------------------------------------"
...
docker exec bank-cli  bash -c 'peer lifecycle chaincode commit -C lending -n lendingchaincode -v 0.0 --sequence 1 --tls --cafile $ORDERER_TLS_ROOTCERT_FILE --peerAddresses bank-peer:7051 --tlsRootCertFiles crypto-config/peerOrganizations/bank-org/peers/bank-peer/tls/ca.crt --peerAddresses audit-peer:7051 --tlsRootCertFiles crypto-config/peerOrganizations/audit-org/peers/audit-peer/tls/ca.crt --peerAddresses fico-peer:7051 --tlsRootCertFiles crypto-config/peerOrganizations/fico-org/peers/fico-peer/tls/ca.crt --peerAddresses insurance-peer:7051 --tlsRootCertFiles crypto-config/peerOrganizations/insurance-org/peers/insurance-peer/tls/ca.crt --peerAddresses title-peer:7051 --tlsRootCertFiles crypto-config/peerOrganizations/title-org/peers/title-peer/tls/ca.crt'
sleep ${FABRIC_START_WAIT}

...
docker exec bank-cli  bash -c "peer lifecycle chaincode commit -C lending --signature-policy \"OR('BankMSP.member', 'FicoMSP.member', 'InsuranceMSP.member', 'AppraiserMSP.member', 'RevenueMSP.member')\" -n lendingchaincode -v 0.0 --sequence 1 --tls --cafile \$ORDERER_TLS_ROOTCERT_FILE --peerAddresses bank-peer:9051 --tlsRootCertFiles crypto-config/peerOrganizations/bank-org/peers/bank-peer/tls/ca.crt --peerAddresses audit-peer:8051 --tlsRootCertFiles crypto-config/peerOrganizations/audit-org/peers/audit-peer/tls/ca.crt --peerAddresses fico-peer:10051 --tlsRootCertFiles crypto-config/peerOrganizations/fico-org/peers/fico-peer/tls/ca.crt --peerAddresses insurance-peer:11051 --tlsRootCertFiles crypto-config/peerOrganizations/insurance-org/peers/insurance-peer/tls/ca.crt --peerAddresses revenue-peer:14051 --tlsRootCertFiles crypto-config/peerOrganizations/revenue-org/peers/revenue-peer/tls/ca.crt --peerAddresses appraiser-peer:7051 --tlsRootCertFiles crypto-config/peerOrganizations/appraiser-org/peers/appraiser-peer/tls/ca.crt"
sleep ${FABRIC_START_WAIT}

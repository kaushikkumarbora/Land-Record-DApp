...
docker exec revenue-cli bash -c "peer chaincode invoke -C registration -n registrationchaincode -c '{\"Args\":[\"signDeed\", \"891011\", \"Signature\", true]}' --tls --cafile \$ORDERER_TLS_ROOTCERT_FILE"
sleep ${FABRIC_START_WAIT}
...
echo -e "................\e[5;32;40msign the Deed \e[m..................................."
docker exec revenue-cli bash -c "peer chaincode invoke -C registration -n registrationchaincode -c '{\"Args\":[\"signDeed\", \"891011\", \"Signature\", false]}' --tls --cafile \$ORDERER_TLS_ROOTCERT_FILE"
sleep ${FABRIC_START_WAIT}
